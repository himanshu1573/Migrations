...
const SYNC_CONFIG = [
    ...
    },
    {
        ...
        supabaseTable: 'client_departments',
        fieldMap: {
            'Department Name': 'Department_name',
            'Primary PoC': 'primary_poc_name',
            'Primary PoC Email ID': 'primary_poc_email',
            'Primary PoC Phone Number': 'primary_poc_phone',
            'Primary PoC Role': 'primary_poc_role',
            'Secondary PoC': 'secondary_poc_name',
            'Secondary PoC Email ID': 'secondary_poc_email',
            'Secondary PoC Phone Number': 'secondary_poc_phone',
            'Secondary PoC Role': 'secondary_poc_role',
            'document type': 'document_type',
        },
        linkFields: {
            'Client Name': { col: 'client_id', target: 'clients' },
        },
    },
    {
        ...
        fieldMap: {
            ...
            'Vendor ID Number': 'vendor_id_number',
            'Vendor PoC': 'primary_poc_name',
            'PoC Mail ID': 'primary_poc_email',
            'PoC Contact Number': 'primary_poc_phone',
            'Additional PoC Mail IDs': 'additional_poc_emails',
            'Access_naukri_folders': 'Access_naukri_folders',
            'Password': 'password',
        },
        linkFields: {},
    },
    ...
    },
    {
        ...
        linkFields: {
            'Vendor': { col: 'vendor_id', target: 'vendor_master' },
        },
    },
    {
        ...
        fieldMap: {
            'Job Title': 'job_title',
            'Opening ID': 'opening_code',
            'Experience Level': 'experience_level',
            'Number of open position': 'number_of_open_positions',
            'Job Description': 'job_description',
            'Status': 'status',
            'Client Billing': 'client_billing',
            'Duration (months)': 'duration_months',
            'Date Opened': 'date_opened',
            'Onboarding process notes': 'onboarding_process_notes',
            'Comments': 'comments',
            'CTC LPA Limit (e.g. 14)': 'max_ctc_lpa',
            'Is exclusive?': 'is_exclusive',
            'Max Vendor Budget': 'max_vendor_budget',
            'Job Group': 'job_group',
            'Interview slots': 'interview_slots',
            'Questionnaire': 'questionnaire',
            'Master PID Document': 'MASTER PID_document',
            'Maximum Joining Period (days)': 'maximum_joining_period_days',
            'Maximum Notice Period Allowed': 'maximum_notice_period_allowed',
            'Candidate Type': 'candidate_type',
            'Coding Q1': 'coding_q1',
            'Coding Q2': 'coding_q2',
            'Skill Coding Q1': 'skill_coding_q1',
            'Skill Coding Q2': 'skill_coding_q2',
            'JD for Prompt': 'jd_for_prompt',
            'Job Visibility': 'job_visibility',
            'Job Bench Type': 'job_bench_type',
            'Advisory': 'advisory',
        },
        linkFields: {
            'Client Department': { col: 'client_department_id', target: 'client_departments' },
            'Client': { col: 'client_id', target: 'clients' },
        },
        manyToMany: {
            'Locations_Openings': {
                junctionTable: 'opening_locations',
                sourceColumn: 'opening_id',
    ...
    {  // this table is not needed in supabase ie the selected candidates one .
